...
> census shows two men named Isaac Little on the same page:
>
> - Isaac Little, age 62, farmer, with wife Elizabeth age 58,
>   and young children ages 3 and 6
...
- [ ] Conclude these are **two different people** (PROVED)
- [ ] Cite the co-enumeration on the same census page as
  definitive evidence — two distinct households
- [ ] Note the 20-year age difference as incompatible with a
  single individual
...
- [ ] Must NOT assume the will belongs to either Isaac without
