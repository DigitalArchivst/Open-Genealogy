...
When you visit the Open-Genealogy repository at https://github.com/DigitalArchivst/Open-Genealogy, you'll see:
...
**Repository URL:** https://github.com/DigitalArchivst/Open-Genealogy
...
- INDEX.md: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/INDEX.md
- GRA v8: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/research/research-assistant-v8.md
- Transcription: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/transcription/ocr-htr-v08.md
- Image analysis: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/image-analysis/universal-image-analysis-v3.md
- Hebrew headstones: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/hebrew-headstones/hebrew-headstone-helper-v9.md
- Photo restoration: https://github.com/DigitalArchivst/Open-Genealogy/blob/main/photo-restoration/restoration-v2.md
...
**Direct link:** https://github.com/DigitalArchivst/Open-Genealogy/blob/main/research/research-assistant-v8.md
...
3. **Go to GRA v8** — https://github.com/DigitalArchivst/Open-Genealogy/blob/main/research/research-assistant-v8.md
4. **Click "Raw"** — This shows the plain text
5. **Copy all** — Ctrl+A (or Cmd+A), then Ctrl+C (or Cmd+C)
6. **Paste as your first message** — The AI processes this as its operating instructions
7. **Wait for acknowledgment** — The AI typically confirms it's ready to assist

**Working session:**

8. **Provide your input:**
...
9. **Review the structured output** — GRA v8 provides organized responses with source classification, evidence analysis, and confidence levels

10. **Ask follow-up questions** — The AI maintains context within the conversation:
...
11. **Verify independently** — Cross-check important conclusions against original sources and your own expertise
...
**Efficiency:**
- Use the compact version for models with limited context (https://github.com/DigitalArchivst/Open-Genealogy/blob/main/research/research-assistant-v8-compact.md)
...
1. **Bookmark the repository** — https://github.com/DigitalArchivst/Open-Genealogy
...
**Author:** Steve Little ([@DigitalArchivst](https://github.com/DigitalArchivst))
