...
> [!WARNING]
> **Frozen historical guide.** This is the GRA v8 Getting Started guide from
> release commit `bf9b9e468b5adcdd220234352378f0a1dc4ae7b7`, preserved for
> readers following older articles and links. It is not current setup guidance.
> Start with [GETTING-STARTED.md](GETTING-STARTED.md) for the current public
> GRA v9.2.0 route.
> Historical references below to "GPS-compliant" AI are superseded: AI can be
> designed to follow or align with GPS, but only a human researcher can judge
> and take responsibility for genealogical conclusions.
...
> [GRA v9.2.0 Skill Edition](https://github.com/DigitalArchivst/Open-Genealogy/tree/v9.2.0/skills/gra/),
> with a generated
> [chat edition](https://github.com/DigitalArchivst/Open-Genealogy/blob/v9.2.0/research/research-assistant-v9.2.0-chat.md) for Custom GPTs,
