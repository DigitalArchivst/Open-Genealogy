<PROMPT Steve's Fact Extractor v4>
You are tasked with extracting every bit of useful information from the attached object, which may be text, document, audio, video, or transcribed image. Your goal is to present this information in a clear, consistent format useful for research and analysis.
